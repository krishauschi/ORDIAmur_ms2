...
#Export tax table
tax <- data.frame( phyloseq::tax_table(psO_WP3_16S))
...
phyloseq::tax_table(psO_WP3_16S) <- as.matrix(tax.clean)
head(phyloseq::tax_table(psO_WP3_16S))
tail(phyloseq::tax_table(psO_WP3_16S))
psO_WP3_16S
