...
# wie sollte ich diese parameter für ITS setzen? 
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, compress = TRUE, truncQ = 2, truncLen=c(240,240), trimLeft=c(17,20), maxN=0, maxEE=c(2,2), rm.phix=TRUE, matchIDs = TRUE, multithread=TRUE)
head(out)

#plot quality after filter
pdf("~/WP3/WP3_dada/dada2_output/plot_Quality_Forward2.pdf")
plotQualityProfile(filtFs[1:6])
dev.off()

pdf("~/WP3/WP3_dada/dada2_output/plot_Quality_Reverse2.pdf")
...
pdf("~/WP3/WP3_dada/dada2_output/plot_error_Forward.pdf")
plotErrors(errF, nominalQ=TRUE)
dev.off()

errR <- learnErrors(filtRs, multithread=TRUE)
pdf("~/WP3/WP3_dada/dada2_output/plot_error_Reverse.pdf")
...
head(mergers[[1]])
seqtab <- makeSequenceTable(mergers)  # first number is samples, here for WP3 n=72, second number is ASVs, here n=57236 
dim(seqtab)
...
#Export results
write.csv(seqtab.nochim.t, "~/WP3/WP3_dada/dada2_output/WP3_16Sseq_Phy_Table.csv")
...
write.csv(track, "~/WP3/WP3_dada/dada2_output/WP3_16Sseq_Quality_Control.csv")

saveRDS(seqtab.nochim, file = "~/WP3/WP3_dada/dada2_output/seqtab.nochim_WP3_16Sseq.rds")
save.image(file = "~/WP3/WP3_dada/dada2_output/dada2_WP3_16Sseq.RData")
...
# UNITE version 9.0 release date 2022-10-16, dynamic file for fungi reference: https://doi.org/10.15156/BIO/2483911 
taxa <- assignTaxonomy(seqtab.nochim, "~/WP3/WP3_dada_ITS/database/sh_general_release_16.10.2022.tgz", minBoot = 0, outputBootstraps = TRUE, multithread=TRUE)
write.csv(taxa, "~/WP3/WP3_dada/dada2_output/WP3_taxa_UNITE9.0_table.csv")
